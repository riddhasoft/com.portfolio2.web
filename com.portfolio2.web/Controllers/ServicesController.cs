...
namespace com.portfolio2.web.Controllers
{
    ...
    public class ServicesController : Controller
    {
        ...
        public ServicesController(comportfolio2webContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Service != null ? 
                          ...
                          Problem("Entity set 'comportfolio2webContext.Service'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'comportfolio2webContext.Service'  is null.");
            }
            var service = await _context.Service.FindAsync(id);
            if (service != null)
            {
